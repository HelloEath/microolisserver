...
public class LoggerUtils {
	...
	@Pointcut("execution(public * com.hello.apigatewayservice.controller..*.*(..)) && !execution(public * com.hello.apigatewayservice.controller.*LoginController.*(..)) && !execution(public * com.hello.apigatewayservice.controller.CommonController.systemLog(..))")
