...
import com.hello.apigatewayservice.repository.PermissionRepository;
import com.hello.apigatewayservice.repository.RoleRepository;
...
import com.hello.apigatewayservice.util.enumeration.Commons;
 ...
 */
    ...
    public List<Region> initRegion(Resource resource, String systemType) {
        try {
            String dictionaryString = com.hello.apigatewayservice.util.FileUtils.getDictionaryString(resource);
