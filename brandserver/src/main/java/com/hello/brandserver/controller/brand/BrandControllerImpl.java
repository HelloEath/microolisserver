package com.hello.brandserver.controller.brand;

import com.hello.brandserver.service.brand.BrandService;
import com.hello.brandserver.service.brand.FileService;
...
public class BrandControllerImpl implements BrandController {
    ...
    @Override
    public  Result<List<ThreeLevelWithYear>> findByThreeId(Long id) {
